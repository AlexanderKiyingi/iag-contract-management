...
// While platform-go lives in the meta-repo, consume it via the relative path.
// Submodule standalone CI will need to drop this replace and pin a published
// version once platform-go is extracted as its own repo.
